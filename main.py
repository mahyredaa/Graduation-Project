...
def intilaiz(name):
    ...
    import pyrebase
    firebaseConfig = {
        "apiKey": "AIzaSyDL2QtrMpW2vJ05WNAE7mQssJ9IQXGFN_g",
        "authDomain": "project-67ee9.firebaseapp.com",
        "projectId": "project-67ee9",
        "storageBucket": "project-67ee9.appspot.com",
        "messagingSenderId": "415482294886",
        "appId": "1:415482294886:web:52fd9b2d5a1dcf3a62b3a7",
        'databaseURL': 'https://console.firebase.google.com/project/project-67ee9/storage/project-67ee9.appspot.com/files'
    };
    ...
    path = "C:/Users/lenovo/Desktop/flask api/" + str(request.args['query'])
...
def image_emotion(videoName,pathToTheVideo):
    ...
    model = tensorflow.keras.models.load_model('imagefinall.h5')
...
def audio_emotion(videoName,pathToTheVideo,full_video_name):
    ...
    soundModel = tensorflow.keras.models.load_model('TestSound.h5')
...
if __name__ =="__main__":
    app.debug = False
    app.run()  # host="0.0.0.0" will make the page accessable
